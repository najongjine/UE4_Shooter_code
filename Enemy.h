...
UCLASS()
class MYSHOOTER_API AEnemy : public ACharacter, public IBulletHitInterface
{
	GENERATED_BODY()
...
private:
	...
	/** Behavior tree for the AI Character. including in inspector for enemycontroller.cpp to have reference of this in on possess. */
