	...
	StunChance(.20f)
{
	...
	CameraBoom->TargetArmLength = 190.f; // The camera follows at this distance behind the character
...
void AShooterCharacter::Die()
{
	...
	auto bPlayingDeathMontage= AnimInstance->Montage_IsPlaying(DeathMontage);
	
	if (AnimInstance && DeathMontage && !bPlayingDeathMontage)
	{
